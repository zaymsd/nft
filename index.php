...
<head>
    ...
    <title>CryptoVerse NFT - Your Gateway to Digital Future</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/roadmap.php">Agenda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/gallery.php">Galeri</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/team.php">Tim</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn-mint" href="pages/mint.php">
                        ...
                        <div class="nft-showcase">
                            <div class="nft-card-3d">
                                <div class="nft-card-inner">
                                    <img src="assets/images/NR_WK04_Delta.png" alt="Featured NFT" class="img-fluid nft-main-image">
                ...
                <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="<?php echo $delay; ?>">
                    <div class="nft-card">
                        <div class="nft-card-image">
                            <img src="assets/images/nft-<?php echo $nft['id']; ?>.png" alt="<?php echo $nft['name']; ?>" class="img-fluid">
            ...
            <div class="cta-box" data-aos="zoom-in">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <p class="cta-text">Don't miss out on this opportunity. Join our community and be part of the future.</p>
                    </div>
